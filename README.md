...
### 🥼 Галерея и редактор скинов

Добавляй, редактируй и экспортируй скины/плащи прямо в лаунчере!

- **Импорт скинов:** Нажмите "+ Добавить" и используйте _поиск по нику_/_импорт .png_/_выбор стива или алекса_.
- **Редактор:** Выберите скин/плащ и нажмите "Редактировать" и попадёте в редактор.
- **Экспортировать:** После рисования вы можете экспортировать как сам _скин_/_плащ_ так и сразу 2 файла в `.png`.

<img src="_previews/skins.png" alt="Скины" width="100%" style="border-radius: 14px; box-shadow: 0 10px 30px rgba(0,0,0,0.7);" />

<img src="_previews/editor.png" alt="Редактор" width="100%" style="border-radius: 14px; box-shadow: 0 10px 30px rgba(0,0,0,0.7);" />
...
> - Лаунчер будет вшивать один из модов `TLSkinsAndCapes`/`CustomSkinLoader` на версиях 1.14+
> - Это нужно для работы скинов на новых версиях в мультиплеере.
